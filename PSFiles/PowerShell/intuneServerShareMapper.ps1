...
$driveLetter = "T" #change to desired driveletter (don't use double colon : )
$path = '\\storage2016\sdrive$' #change to desired server / share path
$shortCutTitle = "T Drive" #this will be the name of the shortcut
